...
for p = 1:length(paths)
    load("./" + paths(p) + "/buildmat/evoke_res2.mat","evp") %get mean MUA
...
for p = 1:length(paths)
    load("./" + paths(p) + "/buildmat/evoke_res2.mat") %get mean MUA
    load("./" + paths(p) +"/buildmat/spnt_evok.mat")
    load("./" + paths(p) + "/shuf_param.mat")
...
for p = 1:length(paths)
    load("./" + paths(p) + "/buildmat/evoke_res3.mat") %get evoked MUA
    load("./" + paths(p) +"/buildmat/spnt_evok.mat")
    load("./" + paths(p) + "/shuf_param.mat")
...
for p = 1:length(paths)
    load("./"+paths(p)+"/buildmat/evoke_resm3.mat")  %get evoked MUA
    load("./" + paths(p) +"/buildmat/spnt_evok.mat")
    load("./" + paths(p) + "/shuf_param.mat")
