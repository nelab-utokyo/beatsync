...
%saveas(gca, path1 + "./summary3/acc_beat_contrast_allr2_"+akinds(apkup)+".fig")
%saveas(gca, path1 + "./summary3/acc_beat_contrast_allr2_"+akinds(apkup)+".png")
...
temp = squeeze(values(:,:,2));

[p,tbl,stats] = kruskalwallis(temp, [], "off");
disp("Kruskalwallis = " + p)  %0.0023, 0.00508
...
saveas(gca, path1 + "./summary3/max_acc_beat2_"+akinds(apkup)+".fig")
saveas(gca, path1 + "./summary3/max_acc_beat2_"+akinds(apkup)+".png")
...
%saveas(gca, path1 + "./summary3/acc_beat_peakpos_a2_"+akinds(apkup)+".fig")
%saveas(gca, path1 + "./summary3/acc_beat_peakpos_a2_"+akinds(apkup)+".png")
...
disp("Kruskalwallis = " + p)  %0.00316, 0.00274
...
saveas(gca, path1 + "./summary3/acc_beat_peaktest_a2_"+akinds(apkup)+".fig")
saveas(gca, path1 + "./summary3/acc_beat_peaktest_a2_"+akinds(apkup)+".png")
...
disp(sum(qualify1))  %3,4,1,2
disp(sum(qualify2))  %1,3,1,1
...
disp(sum(qualify3))  %8,8,7,4
disp(sum(qualify4))  %6,4,2,1
